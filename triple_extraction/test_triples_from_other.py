...
# displacy.render(nlp(original_text), style = "dep", jupyter = True)

original_text = "The UK outlines his plans to break free of European Court after Brexit. The British government will outline its plans to escape the direct jurisdiction of the European Court of Justice after Brexit. one of Prime Minister Theresa May's main aims in talks is to unravel 40 years of European Union membership."

svo = findSVOs(nlp(original_text))

for s in svo:
  if s[0].pos_ == "PRON":
    s[0] = s[0]._.coref_clusters[0][0]
